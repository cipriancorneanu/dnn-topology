...
for e in args.epochs:
    epoch = {}
    for t in thresholds:
        fname = path + 'badj_epc{}_t{:1.2f}_trl{}_sample{}.csv_symmetric_bettis.txt'.format(e, t, args.trial, args.sample)
...
''' Save bettis '''
with open(path + 'bettis_trl{}_p{}_s{}_sample{}.pkl'.format(args.trial, args.permute_labels, args.subset, args.sample), "wb") as f:
